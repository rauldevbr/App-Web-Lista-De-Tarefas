				...
				<div class="container pagina">
					<div class="row">
						<div class="col">
							...
							<?php
							//A variável $tarefas é o retorno de um select feito pela função select() do service 								
							foreach ($tarefas as $key => $value) {
							?>
								<div class="row mb-3 d-flex align-items-center tarefa">
									<div class="col-sm-9" id="tarefa_<?= $value->id ?>">
										<?php
										echo ($value->tarefa . '(' . $value->status . ')');
										?>
									</div>
									<div class="col-sm-3 mt-2 d-flex justify-content-between">
										<i class="fas fa-trash-alt fa-lg text-danger" onclick="del(<?= $value->id ?>)"></i>
